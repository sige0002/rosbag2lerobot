...
class TestDecoderRegistry:
    ...
    def test_register_and_dispatch(self):
        from rosbag2lerobot.decoders import _DECODER_REGISTRY
...
class TestBuiltinDecoders:
    ...
    def test_twist_no_selector(self):
        from rosbag2lerobot.decoders.builtin import decode_twist
    ...
    def test_twist_stamped(self):
        from rosbag2lerobot.decoders.builtin import decode_twist_stamped
    ...
    def test_odometry_no_selector(self):
        from rosbag2lerobot.decoders.builtin import decode_odometry
    ...
    def test_imu_default(self):
        from rosbag2lerobot.decoders.builtin import decode_imu
    ...
    def test_pose_euler_selector(self):
        ...
        from rosbag2lerobot.decoders.builtin import decode_pose
    ...
    def test_euler_bare_selector(self):
        ...
        from rosbag2lerobot.decoders.builtin import _extract_by_selector
        from rosbag2lerobot.transforms import quat_xyzw_to_euler
    ...
    def test_joy_default(self):
        from rosbag2lerobot.decoders.builtin import decode_joy
    ...
    def test_float32(self):
        from rosbag2lerobot.decoders.builtin import decode_float32
    ...
    def test_float64(self):
        from rosbag2lerobot.decoders.builtin import decode_float64
    ...
    def test_float32_multi_array(self):
        from rosbag2lerobot.decoders.builtin import decode_float32_multi_array
    ...
    def test_string(self):
        from rosbag2lerobot.decoders.builtin import decode_string
...
class TestImageDecoders:
    ...
    def test_compressed_jpeg(self):
        from rosbag2lerobot.decoders.image import decode_compressed_image
        import cv2
    ...
    def test_rvl_odd_length_raises_valueerror(self):
        from rosbag2lerobot.decoders.image import _decode_rvl
...
class TestMsgParser:
    ...
    def test_parse_simple_msg(self, tmp_path):
        from rosbag2lerobot.decoders.msg_parser import MsgParser
...
"""
    ...
    def test_msg_decoder_all_fields(self):
        from rosbag2lerobot.decoders.msg_parser import (
            FieldDefinition,
            MsgDecoder,
            MsgDefinition,
        )
